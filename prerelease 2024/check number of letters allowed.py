...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            NumberOfSymbolsAllowed = 3 - self.__GetCell(Row, Column).NoSymbolsNotAllowed()
            print(f"allowed {NumberOfSymbolsAllowed}")
...
class Cell():
    ...
    def NoSymbolsNotAllowed(self):
        return len(self.__SymbolsNotAllowed)
