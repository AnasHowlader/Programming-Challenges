...
def EditSourceCode(SourceCode):
    LineNumber = int(input("Enter line number of code to edit: "))                         #dsfdfndsuifh dsufbidsbf
    while (LineNumber > int(SourceCode[0]) or (LineNumber < 0)):                           #dsfndsiufndsuifnbdsfuibd
        print(f"Number must not exceed {SourceCode[0]}")
