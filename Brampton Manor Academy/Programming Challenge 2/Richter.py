...
print("Energy released for a magnitude of 1: " + str(magnitude(1)/(4.184*10**9)) + " Joules")
print("Energy released for a magnitude of 5: " + str(magnitude(5)/(4.184*10**9)) + " Joules")
print("Energy released for a magnitude of 9.1: " + str(magnitude(9.1)/(4.184*10**9)) + " Joules")
print("Energy released for a magnitude of 9.2: " + str(magnitude(9.2)/(4.184*10**9)) + " Joules")
print("Energy released for a magnitude of 9.5: " + str(magnitude(9.5)/(4.184*10**9)) + " Joules")
